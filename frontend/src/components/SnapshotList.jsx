...
const SnapshotList = ({ snapshots, selectedId, onSelect }) => {
  ...
  if (snaps.length === 0) {
    return (
      <div className="text-center py-10 text-nocturne-text-muted text-xs tracking-wide uppercase">
          ...
          <button
            ...
            className={clsx(
              ...
              isSelected
                ...
                : "border-transparent text-nocturne-text-muted hover:text-nocturne-text-primary"
            )}
          >
            {isSelected && (
              ...
              <div className="min-w-0 flex-1">
                <div
                  className={clsx(
                    ...
                    isSelected
                      ? "text-nocturne-text-primary"
                      : "text-nocturne-text-secondary group-hover:text-nocturne-text-primary"
                  )}
                >
                ...
                <div className="mt-0.5 flex justify-between items-center pr-2">
                  ...
                  {item.row_count > 1 && (
                    <span className="text-[9px] text-nocturne-text-muted">
